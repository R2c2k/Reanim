       ...
       ["conga2"] = 14053147989
        ...
        local function saveKeybinds()
            local tbl = {}
            for k, v in pairs(animationKeybinds) do
                tbl[k] = v.Name
            end
            local success, encoded =
                pcall(
            ...
            if success and writefile then
                pcall(
                    function()
                        writefile("animation_keybinds.json", encoded)
                    end
                )
            end
        end
                ...
                for _, animName in ipairs(sortedAnimationNames) do
                    ...
                    keybindButton.MouseButton1Click:Connect(
                        function()
                            ...
                            local function inputBeganHandler(input)
